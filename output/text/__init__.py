...
def il_to_markdown(output_il: intermediate_lang.OutputIL, output_file: TextIOWrapper) -> None:
    ...
    for line in output_il.lines:
        ...
        output_file.write(f"- Line from {component_start} pin #{start_pin} to {component_end} pin #{end_pin}\n")
